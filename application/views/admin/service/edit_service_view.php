            ...
            <div class="modified-mode">
                <div class="col-lg-10 col-lg-offset-0" style="margin-left: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        echo form_input('title', set_value('title', $service['title']), 'class="form-control" id="title"');
                        ?>
                    </div>
                    ...
                    <div class="form-group picture">
                        ...
                        <br>
                        <img src="<?php echo base_url('assets/upload/service/'.$service['image']) ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        echo form_textarea('description', set_value('description', $service['description']), 'class="form-control" rows="5" ')
                        ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        echo form_textarea('content', set_value('content', $service['content'], false), 'class="form-control content"')
                        ?>
                    </div>
