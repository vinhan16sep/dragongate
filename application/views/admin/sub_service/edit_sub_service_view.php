            ...
            <div class="modified-mode">
                <div class="col-lg-10 col-lg-offset-0" style="margin-left: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        echo form_input('title', set_value('title', $sub_service['title']), 'class="form-control" id="title"');
                        ?>
                    </div>
                    ...
                    <div class="form-group picture">
                        ...
                        <br>
                        <img src="<?php echo base_url('assets/upload/sub_service/'.$sub_service['image']) ?>" width="150px">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        echo form_textarea('description', set_value('description', $sub_service['description']), 'class="form-control" rows="5" ')
                        ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        echo form_textarea('content', set_value('content', $sub_service['content'], false), 'class="form-control content"')
                        ?>
                    </div>
