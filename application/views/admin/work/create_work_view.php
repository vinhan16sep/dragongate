            ...
            <div class="modified-mode">
                <div class="col-lg-10 col-lg-offset-0" style="margin-left: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        echo form_input('customer', set_value('customer'), 'class="form-control" id="customer"');
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                        ...
                        echo form_input('year', set_value('year'), 'class="form-control" id="year"');
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        echo form_dropdown('type', set_value('type', array(0 => 'Hình ảnh', 1 => 'Video')),'', 'class="form-control"');
                        ?>
                    </div>
                    <!-- <div class="form-group">
                        <?php
                        ...
                        echo form_dropdown('service', set_value('service', $service_array),'', 'class="form-control" id="search_service"');
                        ?>
                    </div> -->
                    <div class="form-group">
                        <?php
                        ...
                        echo form_dropdown('sub_service', set_value('sub_service', $sub_services_array),'', 'class="form-control" id="search_sub_service"');
                        ?>
                    </div>
