...
class Service extends Admin_Controller{
	...
	public function index()
	{
        ...
        $total_rows  = $this->service_model->count_search();
        if($keywords != ''){
        ...
        $result = $this->service_model->fetch_all($per_page, $this->data['page']);
        if($keywords != ''){
            $result = $this->service_model->fetch_all($per_page, $this->data['page'], $keywords);
        }
